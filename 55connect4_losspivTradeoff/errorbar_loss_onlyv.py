...
logfile_path1='/data/wangh/hyperparametertuning_a0g/onlyv/55connect4data/logfiles/55connect4_onlyv_run1.log'
logfile_path2='/data/wangh/hyperparametertuning_a0g/onlyv/55connect4data/logfiles/55connect4_onlyv_run2.log'
logfile_path3='/data/wangh/hyperparametertuning_a0g/onlyv/55connect4data/logfiles/55connect4_onlyv_run3.log'
logfile_path4='/data/wangh/hyperparametertuning_a0g/onlyv/55connect4data/logfiles/55connect4_onlyv_run4.log'
logfile_path5='/data/wangh/hyperparametertuning_a0g/onlyv/55connect4data/logfiles/55connect4_onlyv_run5.log'
logfile_path6='/data/wangh/hyperparametertuning_a0g/onlyv/55connect4data/logfiles/55connect4_onlyv_run6.log'
logfile_path7='/data/wangh/hyperparametertuning_a0g/onlyv/55connect4data/logfiles/55connect4_onlyv_run7.log'
logfile_path8='/data/wangh/hyperparametertuning_a0g/onlyv/55connect4data/logfiles/55connect4_onlyv_run8.log'
logfile_path9='/data/wangh/hyperparametertuning_a0g/onlyv/55connect4data/logfiles/55connect4_onlyv_run9.log'
logfile_path10='/data/wangh/hyperparametertuning_a0g/onlyv/55connect4data/logfiles/55connect4_onlyv_run10.log'
...
plt.yticks(np.arange (0,45,0.5))
plt.ylim(0,4)
plt.xticks(np.arange (0,len(list_pi_v[0]), step=20))
plt.xlabel('Training iteration')
plt.ylabel('Loss')
plt.legend(['loss_pi','loss_v'],'upper right')
plt.savefig("errorbar/errorbar_onlyv_55connect4_loss_8runs.eps")
plt.show()
